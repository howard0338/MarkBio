        ...
        <div className="mt-8 grid gap-8 lg:mt-10 lg:grid-cols-[minmax(15rem,0.75fr)_minmax(0,1.5fr)] lg:items-start lg:gap-8">
          ...
          >
            ...
            <div className="mt-3 space-y-4 text-sm leading-relaxed text-brand-navy/75 sm:text-base">
              ...
              <p>
                經由本公司健康產品研究委員會的顧問群（包括中央研究院專家、台大高分子醫學材料博士、醫師及營養師等組成）的研究，人體約有七成淋巴組織分布於腸道，腸道不僅是消化器官，更是重要的免疫防線。現代人長期承受高壓、作息失衡，往往導致腸道菌叢失衡，進而影響整體健康。這也是我深信「守護健康，必須從小處開始」的原因：落實預防醫學，就從照顧腸道生態做起，於是和鼎健生技食品公司一起合作，以找出真正對台灣人體健康有實質幫助的好菌（原生益菌），作為馬克生醫公司簡單、有效、平實價格且高品質的唯一產品。
              </p>
              <p>
