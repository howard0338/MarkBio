        ...
        <div className="mt-8 grid gap-8 lg:mt-10 lg:grid-cols-[minmax(16rem,0.8fr)_minmax(0,1.35fr)] lg:items-start lg:gap-8">
          ...
          >
            ...
            <div className="mt-3 space-y-4 text-sm leading-relaxed text-brand-navy/75 sm:text-base">
              ...
              <p>
                也因此，我始終堅持以科學證據為依歸，尋找真正適合國人的健康方案。人體約有七成淋巴組織分布於腸道，腸道不僅是消化器官，更是重要的免疫防線。現代人長期承受高壓、作息失衡，往往導致腸道菌叢失衡，進而影響整體健康。這也是我深信「守護健康，必須從小處開始」的原因：落實預防醫學，就從照顧腸道生態做起。
              </p>
              <p>
                TCell-1 源自清華大學團隊的尖端技術，透過內視鏡自本土健康成年國人的腸道黏膜組織中，篩選出更適合台灣人體質的本土原生益菌。清大團隊並完成其完整 DNA 序列定序，建立清楚可溯源的菌株身分，且經嚴謹實驗驗證，對 14 種腸道有害菌具有顯著抑制力。此研發成果不僅取得多國專利，更榮獲第一屆國際生醫新創獎最高榮譽。
              </p>
              <p>
