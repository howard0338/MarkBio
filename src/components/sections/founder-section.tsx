        ...
        <div className="mt-8 grid gap-8 lg:mt-10 lg:grid-cols-[minmax(15rem,0.75fr)_minmax(0,1.5fr)] lg:items-start lg:gap-8">
          ...
          >
            ...
            <div className="mt-3 space-y-4 text-sm leading-relaxed text-brand-navy/75 sm:text-base">
              ...
              <p>
                經由本公司健康產品研究委員會的顧問群（包括中央研究院院士、台大高分子醫學工程博士、醫師及營養師等組成）的研究，人體約有七成淋巴組織分布於腸道，腸道不僅是消化器官，更是重要的免疫防線。現代人長期承受高壓、作息失衡，往往導致腸道菌叢失衡，進而影響整體健康。這也是我深信「守護健康，必須從小處開始」的原因：落實預防醫學，就從照顧腸道生態做起，於是和鼎健生技食品公司一起合作，以找出真正對台灣人體健康有實質幫助的好菌（原生益菌）做為馬克生醫公司簡單有效便宜高質量的唯一產品。
              </p>
              <p>
              ...
              <p>
                我始終相信，健康來自每日微小但持續的選擇。從今天起，為自己累積健康資本，讓Tcell-1成為您每天的必備好菌，增強腸道好菌大軍，打敗體內壞菌！讓您每一天都更有活力，減少惱人的常見毛病，例如過敏、口氣芬芳、牙週病、搔癢、容易健忘、胃液逆流、腸胃不適、便秘、體內發炎等，讓您更加健康及真正實踐減少看醫生的預防醫學的願景。
              </p>
              <p
