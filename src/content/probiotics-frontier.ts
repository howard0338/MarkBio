...
export const probioticsFrontierThemes: FrontierTheme[] = [
  {
    title: "腦腸軸與神經退化",
    paragraphs: [
      "人體腸道內棲息著數以兆計的微生物，這些微生物群落（腸道菌群）與宿主之間存在著複雜而精密的互動關係。現代醫學研究指出，腸道菌群透過「腦腸軸」（Microbiota-Gut-Brain Axis, MGBA）與大腦進行雙向溝通，此軸線涉及神經、內分泌和免疫等多個系統。當腸道菌相失衡時，即壞菌數量多於好菌，可能導致腸道通透性增加，形成所謂的「腸漏症」。此時，有害物質如脂多醣（LPS）便可能穿過腸壁進入血液循環，進而引發全身性發炎反應。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "腸道發炎與多種重大疾病的臨床關聯日益明確。例如，在癌症研究中發現，某些壞菌（如特定大腸桿菌）可能產生毒素，促進腫瘤的發生與發展，而好菌則能分解致癌物質，降低罹癌風險。此外，腸道菌群豐富度較高的癌症患者，其免疫治療（如 PD-1 抑制劑）的效果也顯著優於菌群多樣性較低的患者。這表明，透過益生菌治療（如糞便菌群移植）改善腸道菌相，對於緩解腸道發炎和提升免疫功能具有潛在的應用價值。",
    ],
  },
  {
    title: "代謝與慢性病",
  ...
  },
  {
    title: "益生菌的照顧方式",
    paragraphs: [
      "維護腸道健康是促進整體健康的關鍵。以下提供幾種有效的益生菌照顧方式：",
    ],
    bullets: [
      "補充益生菌與益生元：直接補充含有特定菌株（如乳酸桿菌、雙歧桿菌）的益生菌產品，有助於改善腸道生態。同時，攝取益生元（Prebiotics），如菊糖、果寡糖等，這些是益生菌的「食物」，能選擇性地刺激好菌生長，提升益生菌的功效。",
